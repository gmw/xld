...
extern c_block *new_c_block(struct cdrom_paranoia_s *p);
...
extern c_block *c_last(struct cdrom_paranoia_s *p);
extern c_block *c_next(c_block *c);
extern c_block *c_prev(c_block *c);

extern v_fragment *v_first(struct cdrom_paranoia_s *p);
extern v_fragment *v_last(struct cdrom_paranoia_s *p);
